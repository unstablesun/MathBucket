...
public class FuelSDKAndroid : FuelSDKPlatform {
		...
		using (AndroidJavaObject hashMap = new AndroidJavaObject("java.util.HashMap")) {
			if (matchResult != null) {
				...
				foreach (string key in matchResult.Keys) {
					using (AndroidJavaObject hashMapPutMethodArgKey = new AndroidJavaObject("java.lang.String", key)) {
						using (AndroidJavaObject hashMapPutMethodArgValue = new AndroidJavaObject ("java.lang.String", matchResult [key])) {
							object[] args = new object[2];
							args [0] = hashMapPutMethodArgKey;
							args [1] = hashMapPutMethodArgValue;
				...
				succeeded = m_jniFuelSDKUnity.CallStatic<bool> ("submitMatchResult", hashMap);
			}
		}
	...
	public override void SetOrientationUICompete (FuelSDK.ContentOrientation orientation) {
		...
		{
			Debug.Log ("setOrientationuiCompete - invalid notification type");
		}
	...
	public override  void SetOrientationUIIgnite (FuelSDK.ContentOrientation orientation) 
	{
		...
		if (fuelSDKOrientationType == null)
		{
			Debug.Log ("setOrientationuiIgnite - invalid notification type");
		}
		...
		using (AndroidJavaObject hashMap = new AndroidJavaObject("java.util.HashMap")) {
			if (userConditions != null) {
				System.IntPtr hashMapPutMethodId = AndroidJNI.GetMethodID (
					...
					"put",
					"(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
				foreach (string key in userConditions.Keys) {
					using (AndroidJavaObject hashMapPutMethodArgKey = new AndroidJavaObject("java.lang.String", key)) {
						using (AndroidJavaObject hashMapPutMethodArgValue = new AndroidJavaObject ("java.lang.String", userConditions [key])) {
							object[] args = new object[2];
							args [0] = hashMapPutMethodArgKey;
							args [1] = hashMapPutMethodArgValue;
				...
				succeeded = m_jniFuelSDKUnity.CallStatic<bool> ("setUserConditions", hashMap);
